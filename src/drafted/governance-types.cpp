...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "HustCoinNetwork") type = HustCoinNetwork;
    if(strType == "HustCoinNetworkVariable") type = HustCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == HustCoinNetwork) s = "HustCoinNetwork";
    if(type == HustCoinNetworkVariable) s = "HustCoinNetworkVariable";
