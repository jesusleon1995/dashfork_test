 ...
 *
 *   // network
 *   CHustCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.hustcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CHustCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CHustCoinNetwork(UniValue objIn)
    {
...
// // can be under: HustCoinNetwork
// //   -- signature requirements : Key1(User)
// class CHustCoinNetworkVariable : public CGovernanceObject
// {
// private:
