    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("HUST-light"), QVariant("light"));
    ui->theme->addItem(QString("HUST-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("HUST-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("HUST-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("HUST-traditional"), QVariant("trad"));
