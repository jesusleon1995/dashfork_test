    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("HustCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HustCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hustcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About HustCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about HustCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HustCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HustCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HustCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a hustcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HustCoin Core help message to get a list with possible HustCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("HustCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HustCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("HustCoin Core"); // default title
