    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("HustCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About HustCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  hustcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the HustCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 HUST, 0.1 HUST, 1 HUST and 10 HUST -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://hustcoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://hustcoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("HustCoin Core is shutting down...") + "<br /><br />" +
