...
#define BOOST_TEST_MODULE HustCoin Test Suite

#include "test_hustcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_hustcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
