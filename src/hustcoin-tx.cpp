...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("HustCoin Core hustcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hustcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hustcoin transaction") + "\n" +
              "  hustcoin-tx [options] -create [commands]   " + _("Create hex-encoded hustcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hustcoin transaction
