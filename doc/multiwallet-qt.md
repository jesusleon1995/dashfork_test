...
Only requiring some minor changes is hustcoin.cpp.
...
Changes to hustcoin.cpp
----------------------
hustcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
