...
This mechanism has been integrated into Bitcore-Node-HustCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hustcoinpay/insight-api-hustcoin#web-socket-api](https://github.com/hustcoinpay/insight-api-hustcoin#web-socket-api)
* API: [https://github.com/hustcoinpay/insight-api-hustcoin#instantsend-transactions](https://github.com/hustcoinpay/insight-api-hustcoin#instantsend-transactions)
...
By default, the HustCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the HustCoin Core daemon:
